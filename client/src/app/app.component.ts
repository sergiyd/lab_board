...
export class AppComponent implements OnInit, OnDestroy {
	...
	constructor(private readonly _boadService: BoardService,
	...
	public connectionButtonClick() {
		...
		~[BoardServiceStatus.Connecting, BoardServiceStatus.Reconnecting, BoardServiceStatus.Online].indexOf(this._status) ?
