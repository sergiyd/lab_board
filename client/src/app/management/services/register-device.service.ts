...
export class RegisterDeviceService {
  public static readonly buses: readonly DeviceBus[] = Array.from(
    DeviceDecoratorService.buses.filter((b) => b !== DeviceBus.Unknown)
  );
